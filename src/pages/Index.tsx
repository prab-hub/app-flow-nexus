        ...
        <section className="py-12 md:py-16 bg-muted/40">
          <div className="container px-4 md:px-6">
            <div className="text-center max-w-3xl mx-auto">
              <h2 className="text-2xl md:text-3xl font-bold tracking-tight">Admin Access</h2>
              <p className="text-muted-foreground mt-4 text-lg">
                Are you an administrator? Manage applications, categories, and locations from the admin dashboard.
              </p>
              ...
              <p className="mt-4 text-sm text-muted-foreground">
                Note: Login with admin@example.com to access admin features
              </p>
            </div>
          </div>
        </section>
